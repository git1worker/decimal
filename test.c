...
int main() {
  ...
  // 100000010011111100111001011110|00111110001001010000001001100001|00001111111111111111111111111111|11011111101100000011000110100001|11000001110110101111110110011110|11110000000000000000000000000000
  setExp(&dec3, 28);
  setExp(&dec, 28);

  alignmentExp(&dec, &dec2);
  assert(!memcmp(&dec2, &dec3, sizeof(dec)));
