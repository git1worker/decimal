...
int main() {
  ...
  big_decimal num1 = {.bits = {UINTMAX, 0, 123, 2323, 0, 0, 0}};
  big_decimal num2 = {.bits = {456541245, 0, 760, 30, 0, 0, 0}};
  big_decimal res = {};
  setSign(&num1, 1);
  print_decimal(num1);
  print_decimal(num2);
  helperSummSub(num1, num2, &res);
  print_decimal(res);

  // printf("%d = 0\n", bigDecimalIsLess(num1, num2));
  // big_decimal num3 = {.bits = {0, 0, 0, 0, 1233, 0, 0}};
  ...
  // 10000000000001110000000000000000
  return 0;
}

/*
print ("{0:b}".format( -int('100100010011000000000000000000000000011110110000000000000000000000000000000011111111111111111111111111111111', 2) + 
  int('11110000000000000000000000010111110000000000000000000000000000000000000011011001101100100010000111101', 2)) )
